...
public class BabyCobolParser extends Parser {
	...
	public final Add_statementContext add_statement() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( _la==T__2 || ((((_la - 85)) & ~0x3f) == 0 && ((1L << (_la - 85)) & 151L) != 0) );
			setState(278);
			match(TO);
			setState(279);
			((Add_statementContext)_localctx).atomic = atomic();
	...
	public final Display_typesContext display_types() throws RecognitionException {
		...
		try {
			...
			setState(478);
			_la = _input.LA(1);
			if ( !(_la==SIZE || _la==SPACE || _la==LITERAL) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ComparisonExpressionContext comparisonExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==T__0 || _la==T__2 || ((((_la - 85)) & ~0x3f) == 0 && ((1L << (_la - 85)) & 151L) != 0)) {
					{
					setState(610);
